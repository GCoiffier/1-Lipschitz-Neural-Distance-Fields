...
python train_fullinfo.py hand_laurent -ne 1000 -cp 100 --model mlp --n-layers 20 --n-hidden 128 -bs 100 -o hand_laurent_mlp
...
python train_fullinfo.py hand_laurent -ne 1000 -cp 100 --model mlp --n-layers 20 --n-hidden 128 -bs 100 -weik 0.1 -o hand_laurent_mlp_eik
...
python train_fullinfo.py hand_laurent -ne 1000 -cp 100 --model siren --n-layers 5 --n-hidden 256 -bs 1000 -lr 1e-4 -o hand_laurent_siren
...
python train_fullinfo.py hand_laurent -ne 1000 -cp 100 --model siren --n-layers 5 --n-hidden 256 -bs 1000 -lr 1e-4 -weik 0.1 -o hand_laurent_siren_eik
...
# Run SALD
python extract_dataset_surface.py /home/guillaume/Desktop/neuralSDF_inputs/hand_laurent.obj -mode sal -no 50000 -ni 10000 -nt 100

python train_SALD.py hand_laurent -ne 1000 -cp 100 -model mlp --n-layers 20 --n-hidden 128 -bs 100 -wa 1. -o hand_laurent_sal2
python reconstruct_surface.py output/hand_laurent_lip_sal2/model_final.pt -res 200 -d -0.02 -0.01 0. 0.01 0.02 -o hand_laurent_sal2
mv output/*.obj output/hand_laurent_lip_sal2/

python train_SALD.py hand_laurent -ne 1000 -cp 100 -model mlp --n-layers 20 --n-hidden 128 -bs 100 -wa 1. --metric l0 -o hand_laurent_sal0
python reconstruct_surface.py output/hand_laurent_lip_sal0/model_final.pt -res 200 -d -0.02 -0.01 0. 0.01 0.02 -o hand_laurent_sal0
...
python train_lip.py hand_laurent -ne 1000 -cp 50 --model sll --n-layers 20 --n-hidden 128 -bs 1000 -lm 1e-3 -o hand_laurent_lip_sll
