...
python train_fullinfo.py hand_laurent -ne 201 -cp 50 --model mlp   --n-layers 8 --n-hidden 32 -bs 1000 -o hand_laurent_mlp
...
python train_fullinfo.py hand_laurent -ne 201 -cp 50 --model mlp   --n-layers 8 --n-hidden 32 -bs 1000 -weik 0.1 -o hand_laurent_mlp_eik
...
python train_fullinfo.py hand_laurent -ne 201 -cp 50 --model siren --n-layers 8 --n-hidden 32 -bs 1000 -o hand_laurent_siren
...
python train_fullinfo.py hand_laurent -ne 201 -cp 50 --model siren --n-layers 8 --n-hidden 32 -bs 1000 -weik 0.1 -o hand_laurent_siren_eik
...
python train_lip.py hand_laurent -ne 101 -cp 50 --model ortho --n-layers 8 --n-hidden 32 -bs 1000 -wa 10. -lm 1e-6 -o hand_laurent_lip_ortho
...
python train_lip.py hand_laurent -ne 201 -cp 50 --model sll --n-layers 8 --n-hidden 32 -bs 1000 -wa 10. -lm 1e-6 -o hand_laurent_lip_sll
...
# python train_lip.py hand_laurent --unsigned -ne 101 -cp 50 --model ortho --n-layers 8 --n-hidden 32 -bs 200 -wa 10. -o hand_laurent_lip_unsigned_ortho
...
# python train_lip.py hand_laurent --unsigned -ne 201 -cp 50 --model sll --n-layers 8 --n-hidden 32 -bs 200 -wa 10. -o hand_laurent_lip_unsigned_sll
