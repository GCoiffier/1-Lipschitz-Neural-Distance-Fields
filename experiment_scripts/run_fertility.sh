...
### Lidar
python3 extract_dataset_pointcloud.py /home/guillaume/Desktop/neuralSDF_inputs/input_mesh_signed/fertility_lidar.geogram_ascii -no 100000 -ti 5. -to -4 -visu
