...
### Good quality
python3 extract_dataset_pointcloud.py inputs/fertility_good.geogram_ascii -no 30000 -ti 3 -to 0
...
### Sparse
python3 extract_dataset_pointcloud.py inputs/fertility_sparse.geogram_ascii -no 30000 -ti 3 -to 0
...
### Noisy
python3 extract_dataset_pointcloud.py inputs/fertility_noisy.geogram_ascii -no 30000 -ti 10 -to -1 -visu
